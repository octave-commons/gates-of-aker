...
export type WSMessage =
  | { op: "hello"; state: WorldState }
  | { op: "tick"; data: { tick: number; snapshot: WorldState } }
  | { op: "tick_delta"; data: any }
  | { op: "trace"; data: any }
  | { op: "reset"; state: WorldState }
  | { op: "levers"; levers: any }
  | { op: "shrine"; shrine: any }
  | { op: "mouthpiece"; mouthpiece: any }
  | { op: "tiles"; tiles: Record<string, Tile> }
  | { op: "stockpiles"; stockpiles: Record<string, any> }
  | { op: "jobs"; jobs: any[] }
