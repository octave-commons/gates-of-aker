# A good place to start prototyping (the smallest slice that proves *Gates of Aker* is real)

If we zoom way out, *Gates of Aker* has two "this is either amazing or it doesn't work" pillars:
