...
Epics (dependency order) #epic #project-management #planning #architecture
------------------------------
...
Sprint 1 (do next): HexMap backbone + renderer #sprint #implementation #frontend #backend #geometry
------------------------------------------------------
...
Sprint 2 preview (so Sprint 1 choices don't paint you into a corner) #next #planning #iteration #roadmap
--------------------------------------------------------------------------
...
6 neighbor factions + 6 decks (how hex makes it clean) #factions #decks #diplomacy #cards #game-mechanics
-----------------------------------------------------------------------
