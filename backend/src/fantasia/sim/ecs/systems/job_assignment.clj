...
(defn claim-job!
  ...
  [ecs-world agent-id job-id job-type job-queue-type]
  (let [job-queue (be/get-component ecs-world agent-id job-queue-type)]
    (be/add-component ecs-world agent-id (c/->JobAssignment job-id 0.0))
