...
Legacy namespace note: code blocks below keep `fantasia.*` as historical pseudo-code literals, not canonical implementation paths.
...
#game-design #gates-of-aker #clojure #dsl #institutions #macro #metaprogramming #social-sim #belief-systems #organizations #groups
